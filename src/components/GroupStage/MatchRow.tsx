...
import { MatchMetaInfo } from '../shared/MatchMetaInfo'; // Make sure this path is correct based on your folder structure
...
export const MatchRow: React.FC<MatchRowProps> = ({ match }) => {
  ...
  return (
    // Wrapper container: Flex column to stack MetaInfo and the Match data cleanly
    <div className="flex flex-col py-2 border-b border-gray-100 last:border-0 w-full min-w-0">
      
      {/* Top Row: Meta Info (Stadium & Time calculated to Local TZ) */}
      <MatchMetaInfo matchId={match.id} />

      {/* Bottom Row: Teams and Score Inputs (Added pt-1 for slight visual separation) */}
