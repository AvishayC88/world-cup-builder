...
function App() {
  ...
  return (
    <div className="min-h-screen font-sans bg-slate-50 relative flex flex-col">
      ...
      <header className="relative bg-blue-950/95 backdrop-blur-md border-b border-white/20 text-white p-4 shadow-xl z-10">
        ...
        <div className="w-full max-w-[98%] 2xl:max-w-[1800px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          {/* Group 1: Title and the New Smart Reset Button */}
      ...
      <main className="relative z-10 flex-1 overflow-hidden flex flex-col w-full max-w-[98%] 2xl:max-w-[1800px] mx-auto">
