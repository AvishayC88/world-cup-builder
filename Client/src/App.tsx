        ...
        <div className="w-full max-w-[98%] 2xl:max-w-[1800px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-white/10 mt-2">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              disabled={activeTab !== 'PLAYOFFS'}
              title={activeTab !== 'PLAYOFFS' ? 'Switch to Playoffs tab to sync' : 'Sync advancing teams from finished matches'}
      ...
      {showSyncModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative bg-slate-900 border border-white/20 rounded-2xl shadow-2xl p-6 w-[400px] max-w-[90vw] z-10">
            ...
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">
              This will update which team advances to the next round based on real match results. <strong className="text-gray-200">Your predicted scores will NOT be changed</strong> — only the teams in future bracket slots will be updated so upcoming matches show the correct opponent.
            </p>
            <div className="flex justify-end gap-3">
              <button
                onClick={() => setShowSyncModal(false)}
